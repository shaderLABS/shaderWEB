...
<MaterialAppMin theme={$theme}>
	...
	<div class="flex flex-col min-h-screen justify-between">
		<AppBar class="grow-0">
			<span class="text-2xl" style="color: #b676c7; font-family: Consolas, Inconsolata, monospace">shader</span><span
				class="text-2xl"
			...
			<Button fab depressed aria-label="Toggle Light and Dark Theme" on:click={() => ($theme = $theme === 'light' ? 'dark' : 'light')}>
				<Icon
					path={$theme === 'light'
